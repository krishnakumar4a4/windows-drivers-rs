...
* LLVM
* cargo-wdk: our Rust driver build too which you can install by running `cargo install --git https://github.com/microsoft/windows-drivers-rs.git cargo-wdk --locked`
