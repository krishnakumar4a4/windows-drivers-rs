...
use super::{
    ...
    tracing::WPP_PROJECT_CONTROL_BLOCK,
};
use crate::println;
...
pub fn call_safe_driver_entry(
    ...
    if num_controls > 0 {
        // SAFETY: control_blocks points to a valid WPP_MAIN_CB array
        // generated by the wpp_init! macro. We are in single-threaded
        // DriverEntry context.
        unsafe {
            wpp::writer::init_tracing(control_blocks, num_controls, wdm_driver, reg_path);
        }
    }
